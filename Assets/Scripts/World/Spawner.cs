...
public class Spawner : MonoBehaviour
{
    ...
    public GameObject obstacle; // Obstacles = large rock terrain, 
    public GameObject fishingSpot; // FishingSpot = trigger object for activating minigame
    public List<GameObject> powerups; // Powerups = list of different powerup prefabs
    public GameObject shark; // Shark objects
